...
(3, 'Burton Flat Top Snowboard', 'in mint condition', 'https://www.burton.com/static/product/W20/10697106000138_1.png?impolicy=bglt&imwidth=486');

insert into items (user_id, name, description, picture_url) values 
(2, 'Cardboard snowboard', 'Next generation performace focus snowboard', 'https://cdn.instructables.com/FGG/XX8B/JRKYZZ6Y/FGGXX8BJRKYZZ6Y.LARGE.jpg?auto=webp&frame=1&width=761&fit=bounds');

insert into items (user_id, name, description, picture_url) values 
(2, 'Mens Snow Pants', 'Only worn once.', 'https://images-na.ssl-images-amazon.com/images/I/81UOyiYGumL._UX569_.jpg');
